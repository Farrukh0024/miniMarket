...
func (t *transactionRepo) UpdateTransaction(updateTransaction models.UpdateTransaction) (string, error) {
	...
	if _, err := t.db.Exec(query, updateTransaction.Sale_id, updateTransaction.Staff_id, updateTransaction.Amount, updateTransaction.Description, updateTransaction.ID); err != nil {
